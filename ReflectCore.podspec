...
surface. All SDK logic lives here; each platform ships only a thin bridge.
  ...
  # Published from the public repo. Tag the repo to match s.version (e.g. `1.0.0`).
  # Consumers get it via `pod trunk push` (CocoaPods trunk) or, without trunk, a
  # Podfile line: pod 'ReflectCore', :git => 'https://github.com/bablu147/reflect-ios.git', :tag => '1.0.0'
